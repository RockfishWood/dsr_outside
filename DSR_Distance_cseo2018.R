...
cseo_nav <-read_csv("data/survey/2018/2018_cseo_nav_data.csv")
...
cseo_qc <- read_csv("data/survey/2018/2018_cseo_qc.csv")
...
transect_qc <- read_csv("output/transect_qc.csv")
...
pdf("output/2018_cseo_smoothed_transects.pdf")
...
write.csv(outPut, file = "output/cseo_smooth_transect_output.csv") 
...
write.csv(transect_pred, file = "output/2018_cseo_smooth_predict.csv")
...
cseo_transects <- read_csv("data/survey/2018/CSEO_2018_smoothed_transect_lengths.csv") 
...
cseo_bio <- read_csv("data/survey/2018/2018_cseo_species.csv") %>% filter(SPECIES == 145)
view(cseo_bio)
